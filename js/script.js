  ...
  variants.forEach((variant, index) => {
    ...
    card.innerHTML = `
      ...
      <div class="variant-buttons">
        <button class="btn-buy btn-detail" data-variant="${variant.id}">
...
function setupBuyButtons() {
  document.addEventListener("click", (e) => {
    if (e.target.closest(".btn-buy")) {
      ...
      // Populate and show modal with variant details
      if (modal) {
        ...
        if (modalBody) {
          modalBody.innerHTML = `
            ...
            <div class="modal-details">
              <h3>${variant.name}</h3>
              <p class="modal-price">${variant.price}</p>
              <p class="modal-desc">${variant.desc}</p>
              <div class="modal-features">
                <h4>Detail Produk</h4>
                <ul>
                  <li>Netto: 150g (contoh)</li>
                  <li>Bahan: Kentang, minyak, bumbu</li>
          ...
          // attach close handler for the modal internal close button
          const closeBtn = modalBody.querySelector("#closeModalBtn");
          if (closeBtn)
